...
// NewRedisBufferForTest creates a new instance of RedisBufferForTest. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewRedisBufferForTest(t interface {
	mock.TestingT
	Cleanup(func())
}) *RedisBufferForTest {
	mock := &RedisBufferForTest{}
	mock.Mock.Test(t)
...
func (_m *RedisBufferForTest) EXPECT() *RedisBufferForTest_Expecter {
	return &RedisBufferForTest_Expecter{mock: &_m.Mock}
}
...
func (_e *RedisBufferForTest_Expecter) AsReadWriteCloser(parentCtx interface{}, initReadOffset interface{}, dataCheckInt interface{}) *RedisBufferForTest_AsReadWriteCloser_Call {
	return &RedisBufferForTest_AsReadWriteCloser_Call{Call: _e.mock.On("AsReadWriteCloser", parentCtx, initReadOffset, dataCheckInt)}
}

func (_c *RedisBufferForTest_AsReadWriteCloser_Call) Run(run func(parentCtx context.Context, initReadOffset int64, dataCheckInt time.Duration)) *RedisBufferForTest_AsReadWriteCloser_Call {
...
func (_c *RedisBufferForTest_AsReadWriteCloser_Call) Return(readWriteCloser io.ReadWriteCloser) *RedisBufferForTest_AsReadWriteCloser_Call {
	_c.Call.Return(readWriteCloser)
	return _c
}

func (_c *RedisBufferForTest_AsReadWriteCloser_Call) RunAndReturn(run func(parentCtx context.Context, initReadOffset int64, dataCheckInt time.Duration) io.ReadWriteCloser) *RedisBufferForTest_AsReadWriteCloser_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *RedisBufferForTest_Expecter) ReadAt(ctx interface{}, buf interface{}, offset interface{}) *RedisBufferForTest_ReadAt_Call {
	return &RedisBufferForTest_ReadAt_Call{Call: _e.mock.On("ReadAt", ctx, buf, offset)}
}

func (_c *RedisBufferForTest_ReadAt_Call) Run(run func(ctx context.Context, buf []byte, offset int64)) *RedisBufferForTest_ReadAt_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *RedisBufferForTest_ReadAt_Call) Return(n int64, n1 int, n2 int64, err error) *RedisBufferForTest_ReadAt_Call {
...
func (_e *RedisBufferForTest_Expecter) Total(ctx interface{}) *RedisBufferForTest_Total_Call {
	return &RedisBufferForTest_Total_Call{Call: _e.mock.On("Total", ctx)}
}

func (_c *RedisBufferForTest_Total_Call) Run(run func(ctx context.Context)) *RedisBufferForTest_Total_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *RedisBufferForTest_Total_Call) Return(n int64, err error) *RedisBufferForTest_Total_Call {
	_c.Call.Return(n, err)
	return _c
}

func (_c *RedisBufferForTest_Total_Call) RunAndReturn(run func(ctx context.Context) (int64, error)) *RedisBufferForTest_Total_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_e *RedisBufferForTest_Expecter) Write(ctx interface{}, data interface{}) *RedisBufferForTest_Write_Call {
	return &RedisBufferForTest_Write_Call{Call: _e.mock.On("Write", ctx, data)}
}

func (_c *RedisBufferForTest_Write_Call) Run(run func(ctx context.Context, data []byte)) *RedisBufferForTest_Write_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *RedisBufferForTest_Write_Call) Return(n int64, err error) *RedisBufferForTest_Write_Call {
	_c.Call.Return(n, err)
	return _c
}
